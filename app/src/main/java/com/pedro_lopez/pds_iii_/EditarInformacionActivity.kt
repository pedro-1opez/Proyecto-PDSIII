...
import com.pedro_lopez.pds_iii_.databinding.ActivityEditarInformacionBinding
...
class EditarInformacionActivity : AppCompatActivity() {
        ...
        ref.putFile(imagenUri!!)
            .addOnSuccessListener { taskSnapshot ->
                ...
                if (uriTask.isSuccessful) {
                    actualizarInfoDB(urlImagenCargada)
                }
            }
    ...
    private fun actualizarInfoDB(urlImagenCargada: String) {

...
import com.pedro_lopez.pds_iii_.databinding.ActivityCambiarPasswordBinding
...
class CambiarPasswordActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.btnCambiarPasswordPerfil.setOnClickListener {
            validarInformacion()
        }
    }
    ...
    private fun autenticarUsuario() {
        ...
        firebaseUser.reauthenticate(authCredential)
            ...
            .addOnFailureListener { e->
                ...
                Toast.makeText(
                    this,
                    "Fallo la autenticación debido a ${e.message}",
                    Toast.LENGTH_SHORT
                ).show()
            }
    }
    ...
    private fun actualizarPassword() {
        ...
        firebaseUser.updatePassword(pass_nueva)
            ...
            .addOnFailureListener { e->
                ...
                Toast.makeText(
                    this,
                    "Fallo el cambio de contraseña debido a ${e.message}",
                    Toast.LENGTH_SHORT
                ).show()
            }
    }
